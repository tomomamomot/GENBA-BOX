...
const ASSETS = ['./', './index.html', './styles.css?v=20', './app.js?v=19', './brand.js?v=34', './report.js?v=30', './calendar-layout.js?v=24', './range-entries.js?v=28', './calendar-connections.js?v=34', './navigation-controls.js?v=37', './ui-preferences.js?v=20', './manifest.json?v=33', './ninq-logo.svg?v=33', './icon-192.png?v=33', './icon-512.png?v=33', './apple-touch-icon.png?v=33'];
