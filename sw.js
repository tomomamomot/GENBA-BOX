...
const ASSETS = ['./', './index.html', './styles.css?v=16', './app.js?v=16', './brand.js?v=31', './report.js?v=30', './calendar-layout.js?v=22', './range-entries.js?v=27', './calendar-connections.js?v=29', './ui-preferences.js?v=19', './manifest.json?v=16', './ninq-logo.svg', './icon-192.png', './icon-512.png'];
