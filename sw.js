const CACHE = 'genba-box-v18';
const ENHANCEMENT_SCRIPTS = [
  '<script src="report.js?v=17"></script>',
  '<script src="calendar-layout.js?v=18"></script>',
];
const ASSETS = ['./', './index.html', './styles.css?v=16', './app.js?v=16', './report.js?v=17', './calendar-layout.js?v=18', './manifest.json?v=16', './icon-192.png', './icon-512.png'];
