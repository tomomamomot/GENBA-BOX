...
const ASSETS = ['./', './index.html', './styles.css?v=16', './app.js?v=16', './brand.js?v=34', './report.js?v=30', './calendar-layout.js?v=22', './range-entries.js?v=27', './calendar-connections.js?v=32', './ui-preferences.js?v=19', './manifest.json?v=33', './ninq-logo.svg?v=33', './icon-192.png?v=33', './icon-512.png?v=33', './apple-touch-icon.png?v=33'];
