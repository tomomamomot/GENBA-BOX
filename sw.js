...
const ENHANCEMENT_SCRIPTS = [
  ...
  '<script src="calendar-connections.js?v=27"></script>',
  '<script src="ui-preferences.js?v=19"></script>',
];
const ASSETS = ['./', './index.html', './styles.css?v=16', './app.js?v=16', './report.js?v=17', './calendar-layout.js?v=22', './range-entries.js?v=27', './calendar-connections.js?v=27', './ui-preferences.js?v=19', './manifest.json?v=16', './icon-192.png', './icon-512.png'];
